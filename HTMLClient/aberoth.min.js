function App() {
    ...
    if (!this.autoLoad) {
        ...
        this.ipAddress = document.getElementById("ip_address");
        ...
        alert(document.getElementById("ipaddress"));
...
Connection.prototype.createSocket = function() {
    ...
    this.socket = new WebSocket("wss://" + this.client.ipAddress + ":80/GameClientHTML5");
