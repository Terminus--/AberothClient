...
App.prototype.autoStartGame = function () {
	return !!this.prepForStart() && (this.game.run(this.autoLoad.username, this.autoLoad.password, this.autoLoad.scaleup, this.autoLoad.scaledown, this.autoLoad.fontsize, this.autoLoad.screendefinition, this.autoLoad.encryptpassword, this.autoLoad.reloadOnDeath, this.autoLoad.javaversion), !0)
};
		...
		try {
			for (var b = 0; b < a.length;) {
				...
				var c = 0,
					...
					e = a[b],
					g = a[b + 2];
				if (e === this.Types.Compression.NOT_COMPRESSED_FLAG && (d = !1, e = 0), c = e, c *= 256, c *= 256, c += g, a.length < b + 3 + c) {
